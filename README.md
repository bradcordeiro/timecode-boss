...
Anthropic's Opus 4.6, via the Claude Code CLI, was queried to assist with configuring TypeScript and the module exporting fields of package.json. All files were human-edited based on the LLM's recommendations, if useful. No TypeScript files were edited by AI.
